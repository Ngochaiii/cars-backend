{{--
    BẢN CẮT TĨNH trang "Về chúng tôi" — chép 1:1 từ bản thiết kế trong
    resources/views/frontend/website 2 (màn hình #about).
    ...
    Mở /mau/ve-chung-toi để so cạnh trang thật rồi ghép từng khối một.
...
<div style="min-height: 100vh; background: rgb(255, 255, 255); min-width: 1320px;">
  ...
  <div style="max-width: 1280px; margin: 0px auto; display: flex; align-items: center; justify-content: space-between; padding: 0px 32px; height: 76px;">
    ...
    <nav style="display: flex; gap: 28px; font-size: 14px; font-weight: 500; white-space: nowrap;">
        ...
        <span class="scp0" style="cursor: pointer; color: rgb(17, 17, 17); border-bottom: 2px solid rgb(17, 17, 17); padding-bottom: 2px;"><span class="sc-interp">Về chúng tôi</span></span>
  ...
  <div style="max-width: 1280px; margin: 0px auto; padding: 56px 32px 72px;">
    <div style="font-family: ui-monospace, Menlo, monospace; font-size: 11px; letter-spacing: 0.2em; color: rgb(152, 152, 143); text-transform: uppercase; margin-bottom: 14px;">Về chúng tôi</div>
    <h1 style="margin: 0px 0px 36px; font-size: 44px; font-weight: 700; letter-spacing: -0.02em; color: rgb(17, 17, 17); max-width: 720px;">Đại lý ủy quyền phục vụ Bắc Giang từ 2022</h1>
    <div style="height: 420px; border-radius: 4px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 14px, rgb(245, 245, 243) 14px, rgb(245, 245, 243) 28px); display: flex; align-items: center; justify-content: center; margin-bottom: 48px;">
      <span style="font-family: ui-monospace, Menlo, monospace; font-size: 12px; color: rgb(152, 152, 143); letter-spacing: 0.08em;">[ ảnh mặt tiền showroom Bắc Giang ]</span>
    </div>
    <div style="display: grid; grid-template-columns: 1fr 400px; gap: 56px;">
      <div>
        <p style="margin: 0px 0px 20px; font-size: 16px; line-height: 1.8; color: rgb(58, 58, 56);">Chúng tôi là đại lý ủy quyền chính hãng tại tỉnh Bắc Giang, với showroom trưng bày đủ 6 dòng xe, khu lái thử riêng và xưởng dịch vụ 8 khoang đạt chuẩn hãng.</p>
        <p style="margin: 0px 0px 36px; font-size: 16px; line-height: 1.8; color: rgb(58, 58, 56);">Đội ngũ 32 nhân sự — trong đó 12 kỹ thuật viên được đào tạo và cấp chứng chỉ chính hãng — phục vụ hơn 1.200 gia đình trong tỉnh đã chuyển sang xe điện.</p>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; background: rgb(236, 236, 234); border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden;">
          <div style="background: rgb(250, 250, 248); padding: 22px 24px;"><div style="font-size: 26px; font-weight: 700; color: rgb(17, 17, 17);">2022</div><div style="font-size: 12.5px; color: rgb(138, 138, 134); margin-top: 4px;">Năm thành lập</div></div>
          <div style="background: rgb(250, 250, 248); padding: 22px 24px;"><div style="font-size: 26px; font-weight: 700; color: rgb(17, 17, 17);">8 khoang</div><div style="font-size: 12.5px; color: rgb(138, 138, 134); margin-top: 4px;">Xưởng dịch vụ</div></div>
          <div style="background: rgb(250, 250, 248); padding: 22px 24px;"><div style="font-size: 26px; font-weight: 700; color: rgb(17, 17, 17);">4,9/5</div><div style="font-size: 12.5px; color: rgb(138, 138, 134); margin-top: 4px;">Đánh giá khách hàng</div></div>
        </div>
      </div>
      <div style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; padding: 32px; background: rgb(250, 250, 248); height: fit-content;">
        <div style="font-size: 17px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 18px;">Ghé thăm showroom</div>
        <div style="font-size: 14px; line-height: 2; color: rgb(107, 107, 104);">Đường Xương Giang, TP. Bắc Giang<br>Mở cửa 8:00–19:00 hằng ngày<br>Hotline: 0204 xxx xxx<br>Zalo OA: VinFast Bắc Giang</div>
        <div style="margin-top: 22px; height: 180px; border-radius: 4px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 10px, rgb(241, 241, 239) 10px, rgb(241, 241, 239) 20px); display: flex; align-items: center; justify-content: center;"><span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ bản đồ chỉ đường ]</span></div>
        <span class="scp1" style="margin-top: 22px; display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 46px; background: rgb(17, 17, 17); color: rgb(255, 255, 255); font-size: 13.5px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Chỉ đường trên Google Maps</span>
      </div>
    </div>
