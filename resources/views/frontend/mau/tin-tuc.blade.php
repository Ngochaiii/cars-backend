{{--
    BẢN CẮT TĨNH trang "Tin tức" — chép 1:1 từ bản thiết kế trong
    resources/views/frontend/website 2 (màn hình #news).
    ...
    Mở /mau/tin-tuc để so cạnh trang thật rồi ghép từng khối một.
...
<div style="min-height: 100vh; background: rgb(255, 255, 255); min-width: 1320px;">
  ...
  <div style="max-width: 1280px; margin: 0px auto; padding: 56px 32px 72px;">
    <div style="font-family: ui-monospace, Menlo, monospace; font-size: 11px; letter-spacing: 0.2em; color: rgb(152, 152, 143); text-transform: uppercase; margin-bottom: 14px;">Tin tức &amp; Ưu đãi</div>
    <h1 style="margin: 0px 0px 40px; font-size: 44px; font-weight: 700; letter-spacing: -0.02em; color: rgb(17, 17, 17);">Tin mới từ đại lý</h1>
    <div style="display: grid; grid-template-columns: 1.4fr 1fr; gap: 28px; margin-bottom: 28px;">
      <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255); cursor: pointer;">
        <div style="height: 320px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;"><span style="font-family: ui-monospace, Menlo, monospace; font-size: 11px; color: rgb(152, 152, 143);">[ ảnh bài nổi bật ]</span></div>
        <div style="padding: 28px 32px 32px;">
          <div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 10px;"><b style="color: rgb(17, 17, 17); font-weight: 600;">Ưu đãi</b> · 02/07/2026</div>
          <div style="font-size: 24px; font-weight: 700; color: rgb(17, 17, 17); line-height: 1.3; margin-bottom: 10px;">Trả góp 0% lãi suất 24 tháng cho VF 6 và VF 7 trong tháng 7</div>
          <p style="margin: 0px; font-size: 14px; line-height: 1.65; color: rgb(107, 107, 104);">Áp dụng cho khách đặt cọc tại đại lý Bắc Giang, kèm gói lắp sạc tại nhà miễn phí công lắp đặt.</p>
        </div>
      </div>
      <div style="display: flex; flex-direction: column; border: 1px solid rgb(236, 236, 234); border-radius: 4px; background: rgb(255, 255, 255);">
        
          <div class="scpl" style="padding: 24px 28px; border-bottom: 1px solid rgb(236, 236, 234); cursor: pointer;">
            <div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><b style="color: rgb(17, 17, 17); font-weight: 600;"><span class="sc-interp">Sự kiện</span></b> · <span class="sc-interp">28/06/2026</span></div>
            <div style="font-size: 16px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Cuối tuần lái thử VF 3 &amp; VF 5 tại Quảng trường 3/2</span></div>
          </div>
        
          <div class="scpl" style="padding: 24px 28px; border-bottom: 1px solid rgb(236, 236, 234); cursor: pointer;">
            <div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><b style="color: rgb(17, 17, 17); font-weight: 600;"><span class="sc-interp">Hướng dẫn</span></b> · <span class="sc-interp">20/06/2026</span></div>
            <div style="font-size: 16px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Chi phí nuôi xe điện một năm: tính thử với gia đình 4 người</span></div>
          </div>
        
          <div class="scpl" style="padding: 24px 28px; border-bottom: 1px solid rgb(236, 236, 234); cursor: pointer;">
            <div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><b style="color: rgb(17, 17, 17); font-weight: 600;"><span class="sc-interp">Đại lý</span></b> · <span class="sc-interp">12/06/2026</span></div>
            <div style="font-size: 16px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Khai trương khu dịch vụ mở rộng — thêm 4 khoang bảo dưỡng</span></div>
          </div>
        
          <div class="scpl" style="padding: 24px 28px; border-bottom: 1px solid rgb(236, 236, 234); cursor: pointer;">
            <div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><b style="color: rgb(17, 17, 17); font-weight: 600;"><span class="sc-interp">Hướng dẫn</span></b> · <span class="sc-interp">05/06/2026</span></div>
            <div style="font-size: 16px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Sạc tại nhà ban đêm: cách tối ưu chi phí điện bậc thang</span></div>
          </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 28px;">
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255); cursor: pointer;">
          <div style="height: 160px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;"><span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ ảnh ]</span></div>
          <div style="padding: 20px 24px 24px;"><div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><span class="sc-interp">30/05/2026</span></div><div style="font-size: 15.5px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Khách hàng thứ 1.000 nhận xe VF 8 tại Bắc Giang</span></div></div>
        </div>
      
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255); cursor: pointer;">
          <div style="height: 160px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;"><span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ ảnh ]</span></div>
          <div style="padding: 20px 24px 24px;"><div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><span class="sc-interp">22/05/2026</span></div><div style="font-size: 15.5px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">So sánh VF 6 và VF 7: chọn xe nào cho gia đình 5 người?</span></div></div>
        </div>
      
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255); cursor: pointer;">
          <div style="height: 160px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;"><span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ ảnh ]</span></div>
          <div style="padding: 20px 24px 24px;"><div style="font-size: 12px; color: rgb(138, 138, 134); margin-bottom: 8px;"><span class="sc-interp">15/05/2026</span></div><div style="font-size: 15.5px; font-weight: 600; color: rgb(17, 17, 17); line-height: 1.4;"><span class="sc-interp">Lịch bảo dưỡng hè: ưu đãi kiểm tra pin miễn phí</span></div></div>
        </div>
