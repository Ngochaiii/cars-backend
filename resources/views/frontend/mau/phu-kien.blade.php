{{--
    BẢN CẮT TĨNH trang "Phụ kiện xe" — chép 1:1 từ bản thiết kế trong
    resources/views/frontend/website 2 (màn hình #acc).
    ...
    Mở /mau/phu-kien để so cạnh trang thật rồi ghép từng khối một.
...
<div style="min-height: 100vh; background: rgb(255, 255, 255); min-width: 1320px;">
  ...
  <div style="max-width: 1280px; margin: 0px auto; display: flex; align-items: center; justify-content: space-between; padding: 0px 32px; height: 76px;">
    ...
    <nav style="display: flex; gap: 28px; font-size: 14px; font-weight: 500; white-space: nowrap;">
        ...
        <span class="scp0" style="cursor: pointer; color: rgb(17, 17, 17); border-bottom: 2px solid rgb(17, 17, 17); padding-bottom: 2px;"><span class="sc-interp">Phụ kiện</span></span>
  ...
  <div style="max-width: 1280px; margin: 0px auto; padding: 56px 32px 72px;">
    <div style="font-family: ui-monospace, Menlo, monospace; font-size: 11px; letter-spacing: 0.2em; color: rgb(152, 152, 143); text-transform: uppercase; margin-bottom: 14px;"><span style="cursor: pointer;">Trang chủ</span> / Phụ kiện xe</div>
    <h1 style="margin: 0px 0px 36px; font-size: 44px; font-weight: 700; letter-spacing: -0.02em; color: rgb(17, 17, 17);">Phụ kiện xe</h1>
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
      
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Bộ sạc treo tường AC 11 kW</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Bộ sạc treo tường AC 11 kW</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">11.790.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
      
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Sạc di động 2,2 kW</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Sạc di động 2,2 kW</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">6.500.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Thảm sàn 3D theo xe</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Thảm sàn 3D theo xe</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">2.400.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Camera hành trình trước/sau</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Camera hành trình trước/sau</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">3.200.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Ô dù gấp 2 tầng</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Ô dù gấp 2 tầng</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">414.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Áo phủ xe chống nắng</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Áo phủ xe chống nắng</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">1.150.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Bơm lốp điện mini</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Bơm lốp điện mini</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">890.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
        ...
        <div class="scp9" style="border: 1px solid rgb(236, 236, 234); border-radius: 4px; overflow: hidden; background: rgb(255, 255, 255);">
          <div style="height: 170px; background: repeating-linear-gradient(45deg, rgb(236, 236, 234) 0px, rgb(236, 236, 234) 12px, rgb(245, 245, 243) 12px, rgb(245, 245, 243) 24px); display: flex; align-items: center; justify-content: center;">
            <span style="font-family: ui-monospace, Menlo, monospace; font-size: 10px; color: rgb(152, 152, 143);">[ <span class="sc-interp">Mô hình xe VF 3 1:24</span> ]</span>
          </div>
          <div style="padding: 18px 20px 20px;">
            <div style="font-size: 14.5px; font-weight: 600; color: rgb(17, 17, 17); margin-bottom: 4px; min-height: 40px;"><span class="sc-interp">Mô hình xe VF 3 1:24</span></div>
            <div style="font-size: 14px; font-weight: 700; color: rgb(17, 17, 17); margin-bottom: 14px;"><span class="sc-interp">2.074.000 ₫</span></div>
            <span class="scpa" style="display: inline-flex; align-items: center; justify-content: center; width: 100%; height: 40px; border: 1px solid rgb(214, 214, 210); color: rgb(17, 17, 17); font-size: 13px; font-weight: 600; border-radius: 2px; box-sizing: border-box; cursor: pointer;">Liên hệ đặt mua</span>
          </div>
        </div>
